...
- **リリースブランチでバッジとスクリーンショットを自動更新** (#54)
  - リリースブランチ名からバージョンを取得してpackage.jsonとREADMEを自動更新
  - テスト成功後にupdate-assetsジョブでスクリーンショット撮影とバージョン更新
  - バージョン更新コミット後にCIをworkflow_dispatchでトリガー
